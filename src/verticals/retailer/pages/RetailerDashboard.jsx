...
function RetailerDashboard() {
  ...
  return (
        ...
        <ul className="space-y-2 font-medium">
          ...
          >
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Add to Cart</span>
            </a>
          </li>
          <li
            onClick={() => {
    ...
    <div className="p-4 sm:ml-64">
      {activeComponent === null&&<ProductItems/>}
      {activeComponent === "Cart" && <Cart setaActiveComponent={setaActiveComponent} />}
      {activeComponent === "Products" && <ProductItems setaActiveComponent={setaActiveComponent} />}
    </div>
  </div>
  );
}
